 ...
 */
public class OldAccount implements Account {
    ...
    public boolean setMaxCredit(int mc) {
        // TODO: FIX: В незаблокированном состоянии запрещено изменять значение кредитного максимума
